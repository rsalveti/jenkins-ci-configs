...
def setup_args_parser():
    ...
    parser.add_argument("-s", "--server", default="localhost", help="LAVA Server")
...
def process():
    print "Submitting job to LAVA server"
    loadConfiguration()
    user = "admin"
    ...
    server_str = 'http://' + args.server
    xmlrpc_str = 'http://' + user + ":" + apikey + "@" + args.server + '/RPC2/'
